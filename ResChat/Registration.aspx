                ...
                <div>
                    <table class="modal-content">
                        ...
                        <tr class="form-group">
                            ...
                            <td>
                               <div> <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server"  CssClass="alert-danger" ErrorMessage="Username is invalid. A-Z , 0-9 , Underscore &amp; hyphen allowed" ControlToValidate="TextBoxUN" ValidationExpression="^[A-Za-z0-9_-]+$" ValidationGroup="AllValidationGroup" ></asp:RegularExpressionValidator></div>
                        ...
                        <tr class="form-group">
                            <td class="control-label col-sm-2">Department:</td>
                            <td>
                            ...
                            <td class="auto-style7">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="DropDownListCountry" CssClass="alert-danger" ErrorMessage="Department is requried" InitialValue="Select Country" ValidationGroup="AllValidationGroup"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr class="form-group">
                            ...
                            <td class="auto-style14"><a href="login.aspx">Already have an account?</a> 
                                <asp:Button ID="Button1" runat="server"  Text="Home" CssClass="btn btn-default" OnClick="Button1_Click" />
                            </td>
                        </tr>
                        <tr class="form-group">
