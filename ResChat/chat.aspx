            ...
            <asp:Panel ID="Panel2" runat="server">
                <div>
                    ...
                    <p class="alert alert-success" style="text-align: center">
                        <asp:Button ID="Button1" Text="Profile Page" runat="server"  CssClass="btn btn-info" OnClick="Button1_Click"  />
                    </p>
                </div>
            </asp:Panel>
                    ...
                    <div>
                        <table style="width: 120%">
                            <tr>
                                ...
                                <td>                                 
                                    <asp:Button ID="addBTN" runat="server" CssClass="btn btn-default"   Text="+" Width="15%" OnClick="addBTN_Click" />
